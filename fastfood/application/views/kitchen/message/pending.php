...
<head>
	...
	<title>View All Pending Messages || Kitchen Fast Food</title>
				...
				<div class="row heading-bg bg-pink">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>Pending Messages</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
										...
										<div class="table-responsive">
											<table class="table display product-overview mb-30" id="support_table">
                                                ...
                                                <?php if(!empty($message)){ foreach($message as $mess){ ?>
                                                  <form action="<?php echo base_url('kitchen/pending_message/'.$mess->id); ?>" method="POST">
