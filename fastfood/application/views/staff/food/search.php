            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo site_url('staff/food_category/'.$company.'/'.$sea->category); ?>">
                                <?php echo str_replace('-', ' ', $sea->category); ?>
                            </a>
                        </li>
                        <li class="active"><?php echo str_replace('-', ' ', $sea->title); ?></li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="single-product-wrap mb-35">
                                                <div class="product-img product-img-zoom mb-15">
                                                    <a href="<?php echo site_url('staff/food_detail/'.$company.'/'.$sea->id.'/'.strtolower($sea->title)); ?>">
                                                ...
                                                <div class="product-content-wrap-2 text-center">
                                                    <h3>
                                                        <a href="<?php echo site_url('staff/food_detail/'.$company.'/'.$sea->id.'/'.strtolower($sea->title)); ?>">
                                                            <?php echo str_replace('-', ' ', $sea->title); ?>
                                                        </a>
                                                    </h3>
