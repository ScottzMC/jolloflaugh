...
<head>
    ...
    <title>Sort <?php echo $al->date; ?> Food || Fast Food</title>
            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo site_url('staff/food_all/'.$company); ?>">All Foods</a>
                        </li>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="single-product-wrap mb-35">
                                                <div class="product-img product-img-zoom mb-15">
                                                    <a href="<?php echo site_url('staff/food_detail/'.$company.'/'.$al->id.'/'.strtolower($al->title)); ?>">
                                                ...
                                                <div class="product-content-wrap-2 text-center">
                                                    <h3><a href="<?php echo site_url('staff/food_detail/'.$company.'/'.$al->id.'/'.strtolower($al->title)); ?>"><?php echo str_replace('-', ' ', $al->title); ?></a></h3>
                    ...
                    <div class="col-lg-3">
                        <div class="sidebar-wrapper sidebar-wrapper-mrg-right">
                            ...
                            <div class="sidebar-widget shop-sidebar-border mb-35 pt-40">
                                ...
                                <div class="shop-catigory">
                                    <ul>
                                        <li><a href="<?php echo site_url('staff/food_sort_date/'.$company.'/'.strtolower('monday')); ?>">Monday</a></li>
                                        <li><a href="<?php echo site_url('staff/food_sort_date/'.$company.'/'.strtolower('tuesday')); ?>">Tuesday</a></li>
                                        <li><a href="<?php echo site_url('staff/food_sort_date/'.$company.'/'.strtolower('wednesday')); ?>">Wednesday</a></li>
                                        <li><a href="<?php echo site_url('staff/food_sort_date/'.$company.'/'.strtolower('thursday')); ?>">Thursday</a></li>
                                        <li><a href="<?php echo site_url('staff/food_sort_date/'.$company.'/'.strtolower('friday')); ?>">Friday</a></li>
                                        <li><a href="<?php echo site_url('staff/food_sort_date/'.$company.'/'.strtolower('saturday')); ?>">Saturday</a></li>
                                        <li><a href="<?php echo site_url('staff/food_sort_date/'.$company.'/'.strtolower('sunday')); ?>">Sunday</a></li>
                                    </ul>
                                </div>
                            </div>
