...
<head>
    ...
    <title>Sort <?php echo $cat->date; ?> Food || Fast Food</title>
            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo site_url('staff/food_category/'.$company.'/'.strtolower($cat->category)); ?>"><?php echo str_replace('-', ' ', $cat->category); ?> Foods</a>
                        </li>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="single-product-wrap mb-35">
                                                ...
                                                <div class="product-content-wrap-2 text-center">
                                                    <h3><a href="<?php echo site_url('staff/food_detail/'.$company.'/'.$cat->id.'/'.strtolower($cat->title)); ?>">
                                                        <?php echo str_replace('-', ' ', $cat->title); ?></a>
                                                    </h3>
