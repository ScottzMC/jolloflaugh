                                ...
                                <div id="lg1" class="tab-pane active">
                                    <div class="login-form-container">
                                        <div class="login-register-form">
                                            <form action="<?php echo base_url('staff/login'); ?>" method="post">
                                                ...
                                                <div class="button-box">
                                                    <div class="login-toggle-btn">
                                                        ...
                                                        <a href="<?php echo site_url('staff/forgot_password'); ?>">Forgot Password?</a>
                                                    </div>
                                                    <div class="login-toggle-btn">
                                                        <a href="<?php echo site_url('staff/register'); ?>">Do not have an account?</a>
                                                    </div>
