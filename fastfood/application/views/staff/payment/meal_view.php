...
<head>
    ...
    <title>Meal Voucher Payment || Fast Food</title>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <?php foreach($meal_voucher as $vch){} ?>
            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo site_url('staff/meal_voucher/'.$company); ?>">Meal Voucher</a>
                        </li>
                        ...
                        <form action="#">
                            <div class="table-content table-responsive cart-table-content">
                                <table>
                                    ...
                                    <tbody>
                                        <?php if(!empty($meal_voucher)){ foreach($meal_voucher as $vch){ ?>
                                        <tr>
                                            ...
                                            <td class="product-name">
                                                <a href="#">
                                                    <?php echo str_replace('-', ' ', $vch->title); ?> <?php echo $vch->category;?>
                                                </a>
                                            </td>
                                            <td class="product-name">
                                                <p>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="panel panel-default credit-card-box">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="<?php echo base_url('staff/stripe_meal_post/'.$vch->company.'/'.$vch->id); ?>" method="post" 
                                    ...
                                    <input type="hidden" name="category" value="<?php echo $vch->category; ?>">
