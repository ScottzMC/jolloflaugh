                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-6 col-lg-7">
                                    <div class="main-menu main-menu-padding-1 main-menu-lh-3 main-menu-hm4 main-menu-center">
                                        <nav>
                                            <ul>
                                                <li><a class="active" style="font-size: 12px;" href="<?php echo site_url('staff/home/'.$company); ?>">Home </a></li>
                                                <li><a style="font-size: 12px;" href="<?php echo site_url('staff/food_all/'.$company); ?>">Food </a></li>
                    ...
                    <div class="mobile-menu-wrap mobile-header-padding-border-2">
                        ...
                        <nav>
                            <ul class="mobile-menu">
                                <li class="menu-item-has-children"><a href="<?php echo site_url('staff/home/'.$company); ?>">Home</a>
                                </li>
                                <li><a href="<?php echo site_url('staff/food_all/'.$company); ?>">Food </a></li>
                                <?php if($this->session->userdata('urole') == 'Staff'){ ?>
                                    <li><a style="font-size: 12px;" href="<?php echo site_url('staff/logout'); ?>">Logout </a></li>
                                <?php }else if($this->session->userdata('urole') == 'Admin'){ ?>
                                    <li><a style="font-size: 12px;" href="<?php echo site_url('admin/dashboard'); ?>">Admin</a></li>
