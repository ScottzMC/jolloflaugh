...
<head>
    ...
    <title>View Meal Vouchers || Fast Food</title>
            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li class="active">View Meal Vouchers</li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="single-product-wrap mb-35">
                                                <div class="product-img product-img-zoom mb-15">
                                                    <a href="#">
                                                        <img height="270" width="324" src="<?php echo base_url('uploads/banner/banner1.jpg'); ?>" alt="<?php echo $vch->title; ?>">
                                                    </a>
                                                ...
                                                <div class="product-content-wrap-2 product-content-position text-center">
                                                    ...
                                                    <div class="pro-add-to-cart">
                                                        <a href="<?php echo site_url('staff/make_meal_payment/'.$vch->company.'/'.$vch->id); ?>">Purchase</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
