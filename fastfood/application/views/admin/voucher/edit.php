...
<html lang="en">
	<head>
		...
		<?php }else{ ?>
		<title>Edit Voucher || Fast Food</title>
		<?php } ?>
	</head>
  					...
  					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
  					  <ol class="breadcrumb">
                            <li><a href="<?php echo site_url('admin/dashboard'); ?>">Dashboard</a></li>
  							<li><a href="<?php echo site_url('admin/view_voucher'); ?>"><span>Voucher</span></a></li>
  							<li class="active"><span>Edit <?php echo $edt_vouc->title; ?> Voucher</span></li>
  					  </ol>
  					</div>
  					<!-- /Breadcrumb -->
  				</div>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/edit_voucher/'.$edt_vouc->id); ?>" method="POST" enctype="multipart/form-data">
												<h6 class="txt-dark capitalize-font"><i class="icon-list mr-10"></i>about voucher</h6>
												<hr>
                                                <div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label mb-10">Title</label>
															<input type="text" name="title" class="form-control" placeholder="" value="<?php echo $edt_vouc->title; ?>">
