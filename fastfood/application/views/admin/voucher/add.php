...
<html lang="en">
	<head>
		...
		<title>Add New Voucher || Fast Food</title>
	</head>
              ...
              <div class="container-fluid">
  				...
  				<div class="row heading-bg  bg-pink">
  					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
  					  <h5 class="txt-light">Upload Voucher</h5>
  					</div>
  					<!-- Breadcrumb -->
  					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
  					  <ol class="breadcrumb">
                            <li><a href="<?php echo site_url('admin/dashboard'); ?>">Dashboard</a></li>
  							...
  							<li class="active"><span>Upload a Coupon</span></li>
  					  </ol>
  					</div>
  					<!-- /Breadcrumb -->
  				</div>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/add_voucher'); ?>" method="POST" enctype="multipart/form-data">
												<h6 class="txt-dark capitalize-font"><i class="icon-list mr-10"></i>about coupon</h6>
												<hr>
                                                <div class="row">
													<div class="col-md-6">
