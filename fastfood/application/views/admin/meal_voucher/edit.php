...
<html lang="en">
	<head>
		...
		<?php if(!empty($edit_vouchers)){ foreach($edit_vouchers as $edt_vouc){} ?>
		<title>Edit <?php echo $edt_vouc->title; ?> Voucher || Fast Food</title>
		<?php }else{ ?>
		<title>Edit Meal Voucher || Fast Food</title>
		<?php } ?>
	</head>
              ...
              <div class="container-fluid">
  				...
  				<div class="row heading-bg  bg-pink">
  					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
  					  <h5 class="txt-light">Edit <?php echo $edt_vouc->title; ?> Voucher</h5>
  					</div>
  					<!-- Breadcrumb -->
  					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
  					  <ol class="breadcrumb">
                            <li><a href="<?php echo site_url('admin/dashboard'); ?>">Dashboard</a></li>
  							<li><a href="<?php echo site_url('admin/view_meal_voucher'); ?>"><span>Meal Voucher</span></a></li>
  							<li class="active"><span>Edit <?php echo $edt_vouc->title; ?> Meal Voucher</span></li>
  					  </ol>
  					</div>
  					<!-- /Breadcrumb -->
  				</div>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/edit_meal_voucher/'.$edt_vouc->code.'/'.$edt_vouc->id); ?>" method="POST" enctype="multipart/form-data">
												<h6 class="txt-dark capitalize-font"><i class="icon-list mr-10"></i>about meal voucher</h6>
												<hr>
                                                <div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label mb-10">Title</label>
															<input type="text" name="title" class="form-control" placeholder="" value="<?php echo str_replace('-', ' ', $edt_vouc->title); ?>">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" name="price" class="form-control" placeholder="1000" value="<?php echo $edt_vouc->price; ?>" required>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" name="quantity" class="form-control" placeholder="1" value="<?php echo $edt_vouc->quantity; ?>" required>
													...
													<div class="col-md-6">
														<div class="form-group">
                                                            ...
                                                            <select class="form-control" data-placeholder="Choose a Voucher Type" name="category" required>
                                                                <option value="<?php echo $edt_vouc->category; ?>"><?php echo str_replace('-', ' ', $edt_vouc->category); ?></option>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" name="discount" class="form-control" placeholder="10" value="<?php echo $edt_vouc->discount; ?>" required>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																<div class="input-group-addon"><i>#</i></div>
																<input type="text" name="code" class="form-control" placeholder="VVV" value="<?php echo $edt_vouc->code; ?>" required>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="panel-wrapper collapse in">
															<div class="panel-body">
																<textarea id="editordata" class="summernote" rows="7" cols="15" name="description" required><?php echo $edt_vouc->description; ?></textarea>
