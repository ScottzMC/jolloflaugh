...
<head>
	...
	<title>View All Meal Vouchers || Admin Fast Food</title>
            ...
            <div class="container-fluid">
				...
				<div class="row heading-bg bg-pink">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-light">View All Meal Vouchers</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						<li><a href="<?php echo site_url('admin/dashboard'); ?>">Dashboard</a></li>
						<li><a href="#"><span>Meal Vouchers</span></a></li>
						<li class="active"><span>View Meal Vouchers</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
				<!-- /Title -->
                 ...
                 <script>
                    ...
                    $.post('<?php echo base_url('admin/delete_meal_voucher'); ?>', {"del_id": del_id}, function(data){
                      location.reload();
                      $('#cti').html(data)
                      });
                    }
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Meal Vouchers</h6>
								</div>
											...
											<table class="table display product-overview mb-30" id="support_table">
												...
												<tbody>
													...
													<tr>
                            							...
                            							<td><?php echo str_replace('-', ' ', $vouch->category); ?></td>
                                                        <td><?php echo $vouch->discount; ?>%</td>
                                                        <td><?php echo $vouch->company; ?></td>
                                                        <td><?php echo $vouch->bulk; ?></td>
                                                        <td>
                                                            <a href="<?php echo site_url('admin/edit_meal_voucher/'.$vouch->code.'/'.$vouch->id); ?>" class="btn btn-info btn-icon-anim btn-square" title="Edit Voucher">
