...
<html lang="en">
	<head>
		...
		<title>Add New Company || Fast Food</title>
	</head>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/add_company'); ?>" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="panel-wrapper collapse in">
															<div class="panel-body">
																<textarea id="editordata" class="summernote" rows="7" cols="15" name="main_address" required></textarea>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/add_company_address'); ?>" method="POST">
												...
												<div class="row">
												    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label mb-10">Company Name</label>
                                                            <select class="form-control" data-placeholder="Choose a company name" name="title" required>
                                                                <option>Select</option>
												...
												<div class="form-actions">
													<button type="submit" name="add_address" class="btn btn-success btn-icon left-icon mr-10">
                                                        <i class="fa fa-check"></i>
                                                        <span>Upload</span>
                                                      </button>
												</div>
