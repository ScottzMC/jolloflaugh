                        ...
                        <div class="border-bottom-6">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-lg-2">
                                    <div class="logo">
                                        <a href="<?php echo site_url('food_order'); ?>"><img src="<?php echo base_url('assets/images/logo/logo.png'); ?>" alt="logo"></a>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-7">
                                    <div class="main-menu main-menu-padding-1 main-menu-lh-3 main-menu-hm4 main-menu-center">
                                        <nav>
                                            <ul>
                                                <li><a class="active" style="font-size: 12px;" href="<?php echo site_url('food_order'); ?>">HOME </a></li>
                                                <?php if($this->session->userdata('urole') == 'User'){ ?>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('food_order/logout'); ?>">Logout </a></li>
                                                <?php }else if($this->session->userdata('urole') == 'Admin'){ ?>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('food_order/logout'); ?>">Logout </a></li>
                                                <?php }else if($this->session->userdata('urole') == 'Kitchen'){ ?>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('food_order/logout'); ?>">Logout </a></li>
                                                <?php }else{ ?>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('food_order/login'); ?>">Login </a></li>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('food_order/register'); ?>">Register </a></li>
                                                <?php } ?>
                                            </ul>
                                        </nav>
                                    </div>
                    ...
                    <div class="mobile-menu-wrap mobile-header-padding-border-2">
                        ...
                        <nav>
                            <ul class="mobile-menu">
                                <li class="menu-item-has-children"><a href="<?php echo site_url('food_order'); ?>">Home</a></li>
                            <?php if($this->session->userdata('urole') == 'User'){ ?>
                                <li><a style="font-size: 12px;" href="<?php echo site_url('food_order/logout'); ?>">Logout </a></li>
                            <?php }else if($this->session->userdata('urole') == 'Admin'){ ?>
                                <li><a style="font-size: 12px;" href="<?php echo site_url('food_order/logout'); ?>">Logout </a></li>
            ...
            <div class="sidebar-cart-all">
                ...
                <div class="cart-content">
                      ...
                      ?>
                        <li class="single-product-cart">
                            ...
                            <div class="cart-delete">
                                <a href="<?php echo site_url('food_order/remove_cart/'.$item['rowid']); ?>">×</a>
                            </div>
                        </li>
                        <?php endforeach; ?>
                        <?php endif; ?>
                    ...
                    <div class="cart-checkout-btn">
                        <a class="btn-hover cart-btn-style" href="<?php echo site_url('food_order/view_cart'); ?>">view cart</a>
                        <a class="no-mrg btn-hover cart-btn-style" href="<?php echo site_url('food_order/checkout'); ?>">checkout</a>
                    </div>
                </div>
            </div>
        </div>