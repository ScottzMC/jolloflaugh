        ...
        <div class="breadcrumb-area bg-gray">
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        <li>
                            <a href="<?php echo site_url('food_order'); ?>">Home</a>
                        </li>
          ...
          <script>
            ...
            function updateCartItem(obj, rowid){
                $.get("<?php echo base_url('food_order/updateItemQty'); ?>", {rowid:rowid, qty:obj.value}, function(resp){
                    window.location.href="<?php echo site_url('food_order/view_cart'); ?>";
                    /*if(resp == 'ok'){
                        location.reload();
                    }else{
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-remove">
                                                <a href="<?php echo site_url('food_order/remove_cart/'.$item['rowid']); ?>"><i class="icon_close"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php endif; ?>
                                ...
                                <div class="col-lg-12">
                                    <div class="cart-shiping-update-wrapper">
                                        <div class="cart-shiping-update">
                                            <a href="<?php echo site_url('food_order'); ?>">Continue Shopping</a>
                                        </div>
                                        <div class="cart-clear">
                                            <button type="button" onchange="updateCartItem(this, '<?php echo $item["rowid"]; ?>')">Update Cart</button>
                                            <a href="<?php echo site_url('food_order/clear_cart'); ?>">Clear Cart</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="grand-totall">
                                    ...
                                    <a href="<?php echo site_url('food_order/checkout'); ?>">Proceed to Checkout</a>
                                </div>
                            </div>
