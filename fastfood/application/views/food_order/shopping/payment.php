            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo site_url('food_order/view_cart'); ?>">Shopping Cart</a>
                        </li>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if ($cart = $this->cart->contents()): ?>
                                          ...
                                          <?php foreach($cart as $item):
                                           ...
                                           ?>
                                          <?php echo form_open('food_order/update_cart'); ?>
                                          <?php
                                ...
                                <div class="col-lg-12">
                                    <div class="cart-shiping-update-wrapper">
                                        <div class="cart-shiping-update">
                                            <a href="<?php echo site_url('food_order/home/'.$company); ?>">Continue Shopping</a>
                                        </div>
                                    </div>
                                </div>
                            </div>-->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="panel panel-default credit-card-box">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="<?php echo base_url('food_order/stripe_order_post'); ?>" method="post" 
