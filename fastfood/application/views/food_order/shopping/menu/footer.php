                            ...
                            <div class="footer-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a style="font-size: 16px;" href="<?php echo site_url('food_order/logout'); ?>">Logout </a></li>
                                    ...
                                    <?php }else if($this->session->userdata('urole') == 'User'){?>
                                        <li><a style="font-size: 16px;" href="<?php echo site_url('food_order/logout'); ?>">Logout </a></li>
                                    <?php }else{ ?>
                                        <li><a style="font-size: 16px;" href="<?php echo site_url('food_order/login'); ?>">Login </a></li>
                                        <li><a style="font-size: 16px;" href="<?php echo site_url('food_order/register'); ?>">Register </a></li>
                                    <?php } ?>
                                    </ul>
                                </nav>
                            </div>
