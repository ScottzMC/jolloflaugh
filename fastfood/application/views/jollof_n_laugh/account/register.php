...
<head>
    ...
    <title>Register || Jollof N Laugh</title>
                                ...
                                <div id="lg2" class="tab-pane active">
                                    <div class="login-form-container">
                                        <div class="login-register-form">
                                            <form action="<?php echo base_url('jollof_n_laugh/register'); ?>" method="POST">
                                                ...
                                                <div class="button-box">
                                                    <div class="login-toggle-btn">
                                                        <a href="<?php echo site_url('jollof_n_laugh/login'); ?>">Already have an account?</a>
                                                    </div>
