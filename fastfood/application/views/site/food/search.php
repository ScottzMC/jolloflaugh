...
<head>
    ...
    ?>
    <title><?php echo $search_query; ?> || Fast Food</title>
    <?php }else{ ?>
    <title>No Search Result || Fast Food</title>
    <?php } ?>
            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo site_url('food/all'); ?>">All</a>
                        </li>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="single-product-wrap mb-35">
                                                <div class="product-img product-img-zoom mb-15">
                                                    <a href="<?php echo site_url('food/detail/'.$sea->id.'/'.strtolower($sea->title)); ?>">
                                                        <img height="270" width="324" src="<?php echo base_url('uploads/food/'.$sea->image1); ?>" alt="<?php echo $sea->title; ?>">
                                                    </a>
                                                ...
                                                <div class="product-content-wrap-2 text-center">
                                                    <h3><a href="<?php echo site_url('food/detail/'.$sea->id.'/'.strtolower($sea->title)); ?>"><?php echo str_replace('-', ' ', $sea->title); ?></a></h3>
                                                    <div class="product-price-2">
                                                        <span>£<?php echo $sea->price; ?></span>
                                                    </div>
                                                </div>
                                                <div class="product-content-wrap-2 product-content-position text-center">
                                                    ...
                                                    <?php
                                                        ...
                                                        $startTime = $sea->delivery_start;
                                                        $endTime = $sea->delivery_end;
                                                        
                                                        if($currentHour >= $startTime && $currentHour < $endTime){ 
                                                    ?> 
                                                    <div class="pro-add-to-cart">
                                                        <form action="<?php echo base_url('shopping/add_cart'); ?>" method="POST">
                                                            <input type="hidden" name="id" value="<?php echo $sea->id; ?>">
                                                            <input type="hidden" name="code" value="<?php echo $sea->code; ?>">
                                                            <input type="hidden" name="title" value="<?php echo $sea->title; ?>">
                                                            <input type="hidden" name="category" value="<?php echo $sea->category; ?>">
                                                            <input type="hidden" name="price" value="<?php echo $sea->price; ?>">
                                                            <input type="hidden" name="image" value="<?php echo $sea->image1; ?>">
