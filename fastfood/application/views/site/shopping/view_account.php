                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4">
                                    <div class="myaccount-tab-menu nav" role="tablist">
                                        ...
                                        <a href="#schedule" data-toggle="tab"><i class="fa fa-cart-arrow-down"></i> Schedule Delivery</a>
                                        <a href="#address" data-toggle="tab"><i class="fa fa-map-marker"></i> Address</a>
                                        <a href="#account-info" data-toggle="tab"><i class="fa fa-user"></i> Account Details</a>
                                        <a href="<?php echo site_url('account/logout'); ?>"><i class="fa fa-sign-out"></i> Logout</a>
                                    </div>
                                </div>
                                <!-- My Account Tab Menu End -->
                                    ...
                                    <script>
                                     function cancelOrder(id){
                                       ...
                                       $.post('<?php echo base_url('shopping/cancel_order'); ?>', {"ord_id": ord_id}, function(data){
                                         location.reload();
                                         $('#cte').html(data)
                                         });
                                       }
                                    ...
                                    function deleteOrder(id){
                                      ...
                                      if(confirm("Are you sure you want to delete this order")){
                                         $.post('<?php echo base_url('shopping/delete_order'); ?>', {"del_id": del_id}, function(data){
                                         location.reload();
                                         $('#cti').html(data)
                                        });
                                      }
                                    ...
                                    function deleteMessage(id){
                                      ...
                                      if(confirm("Are you sure you want to delete this ticket")){
                                         $.post('<?php echo base_url('shopping/delete_message'); ?>', {"del_id": del_id}, function(data){
                                         location.reload();
                                         $('#ctm').html(data)
                                        });
                                      }
                                    ...
                                    <div class="tab-content" id="myaccountContent">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>£<?php echo $wish->price; ?></td>
                                                                <td><a class="check-btn sqr-btn" href="<?php echo site_url('food/detail/'.$wish->food_id.'/'.$wish->title); ?>">View</a></td>
                                                            </tr>
                                                            <?php } }else{ echo ''; } ?>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="tab-pane fade" id="messages" role="tabpanel">
                                            ...
                                            <div class="myaccount-content">
                                                ...
                                                <div class="account-details-form">
                                                    <form action="<?php echo base_url('shopping/send_ticket'); ?>" method="POST">
                                                        <?php 
                                        ...
                                        <div class="tab-pane fade" id="schedule" role="tabpanel">
                                            <div class="myaccount-content">
                                                ...
                                                <address>
                                                    <p>Date - <?php echo $sch->delivery_date; ?></p>
                                                    <p>Time - <?php echo $sch->num_time; ?></p>
                                                    <p>Postcode - <?php echo $sch->postcode; ?></p>
                                                </address>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="account-info" role="tabpanel">
                                            <div class="myaccount-content">
                                                ...
                                                <div class="account-details-form">
                                                    <form action="<?php echo base_url('shopping/my_account'); ?>" method="POST">
