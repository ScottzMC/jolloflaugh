...
// class methods
    ...
    function install() {
	  //customer groups
	  tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Restrict to customer groups (default=1).', 'MODULE_PAYMENT_COD_GROUPS', '1', 'Comma separated list of customer group numbers.', '6', '5', now())");
	  //
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('COD Exclude these Zones', 'MODULE_PAYMENT_COD_EXCEPT_ZONE', '4', 'If a zone is selected, disable this payment method for that zone.', '6', '4', 'tep_cfg_pull_down_zone_classes(','tep_get_zone_class_title', now())");
