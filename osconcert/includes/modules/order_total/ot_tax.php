...
defined('_FEXEC') or die();
  ...
  class ot_tax {
    ...
    function process() {
      ...
      //FOREACH
        ...
        if ($value > 0) {
			...
			//$god_amount = (19/100)*8.4;+$god_amount
			//$god_amount = (19/100)*1.68*5;
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_ORDER_TOTAL_TAX_SORT_ORDER', '90', 'Sort order of display.', '6', '2', now())");
    }
