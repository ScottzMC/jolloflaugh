...
require_once 'includes/classes/mail/src/Exception.php';
require_once 'includes/classes/mail/src/PHPMailer.php';
require_once 'includes/classes/mail/src/SMTP.php';
