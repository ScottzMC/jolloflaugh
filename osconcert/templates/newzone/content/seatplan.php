...
?>
		<div style="height:60px">
			<div id="btnCheckOut" class="checkout" style="display:true;text-align:center">
			<h2><?php 
			echo '<a href="' . tep_href_link('shopping_cart.php') . '">' . sprintf(MODULE_NAVBAR_SHOPPING_CART_HAS_CONTENTS, $cart->count_contents_gt(), $currencies->format($cart->show_total())) . '</a>';
			//echo sprintf(MODULE_NAVBAR_SHOPPING_CART_CONTENTS, $cart->count_contents_gt()); 
			?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
