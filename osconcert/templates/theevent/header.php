...
if (DOWN_FOR_MAINTENANCE == 'true')
	...
	<ul>
	    	    <li><a href="https://scottnnaghor.com/jollof_n_laugh/home">Home</a></li>
	<?php
	...
	require_once(DIR_WS_TEMPLATES .'theme_select.php');
	?></div>
	<?php } ?>
    <ul>
	...
	<a class="buy-tickets scrollto" href="featured_categories.php"><?php echo TEXT_GET_TICKETS; ?></a>
	</div><!-- .container -->
	</header><!-- #header -->
	<?php
