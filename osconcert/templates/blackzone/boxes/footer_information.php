...
Copyright (c) 2003 osCommerce 
  ...
  <li><i class="fa fa-angle-right"></i> <?php echo '<a href="'.tep_href_link(FILENAME_DEFAULT,'stcPath=4').'">About Us</a>';?></li>
              <li><i class="fa fa-angle-right"></i> <?php echo '<a href="'.tep_href_link(FILENAME_DEFAULT,'stcPath=1').'">About Tickets</a>';?></li>
              <li><i class="fa fa-angle-right"></i> <?php echo '<a href="'.tep_href_link(FILENAME_DEFAULT,'stcPath=3').'">'.BOX_INFORMATION_CONDITIONS.'</a>';?></li>
              <li><i class="fa fa-angle-right"></i> <?php echo '<a href="'.tep_href_link(FILENAME_DEFAULT,'stcPath=2').'">'.BOX_INFORMATION_PRIVACY.'</a>';?></li>
...
defined('_FEXEC') or die();
	...
	$MASTER_BOX_HTML='<li><i class="fa fa-angle-right"></i><a href="{{LINK_1}}">{{NAME}}</a></li>'."\n";
	...
	{
		global $static_foo, $page_categories_string, $page_display_id, $template_html,$BOX_CONTENT_ICON,$INITIAL_WIDTH;
...
<?php
	...
	// echo '<div class="list-group-item list-group-item-action"><a href="' .BOX_INFORMATION_CONTACT_LINK. '">' .BOX_INFORMATION_CONTACT. '</a></div>';
	// }
	// echo '<div class="list-group-item list-group-item-action"><a href="search_events.php">Search Events</a></div>';
	// echo '</div>';
	// //echo '</div>';
