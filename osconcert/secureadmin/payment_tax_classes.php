...
// Set flag that this is a parent file
   ...
   frequire($FSESSION->language.'/payment_taxclass.php',RLANG);
    
	$PAYMENTTAXCLASSES=(new instance)->getTweakObject('display.paymentTaxClasses');
	$PAYMENTTAXCLASSES->pagination=true;
	checkAJAX('PAYMENTTAXCLASSES');	 
	
	$FSESSION->set("AJX_ENCRYPT_KEY",rand(1,10));
	 
	$jsData->VARS["page"]=array('lastAction'=>false,'opened'=>array(),'locked'=>false,'NUlanguages'=>$LANGUAGES,'imgPath'=>DIR_WS_IMAGES,"menu"=>array(),'link'=>tep_href_link('payment_tax_classes.php'),'searchMode'=>false,'AJX_KEY'=>$FSESSION->AJX_ENCRYPT_KEY,'crypted'=>$ENCRYPTED,'alterRows'=>true);
	$jsData->VARS["page"]["template"]=array("ERROR_TAX_CLASS_TITLE"=>ERROR_TAX_CLASS_TITLE,
											"ERROR_TAX_CLASS_DESCRIPTION"=>ERROR_TAX_CLASS_DESCRIPTION,
...
<script type="text/javascript" src="includes/tweak/js/payment_taxclass.js"></script>
</head>
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
	...
	<tr class="dataTableHeadingRow">
		...
		<tr>
				...
				<td width="50%" class="main" align="right" style="display:none">
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td id="taxtotalContentResult">
					<?php $PAYMENTTAXCLASSES->doItems();?>
				</td>
			</tr>
		</table>
		</td>
	...
	<form name="fileUpload" id="fileUpload" action="payment_taxclass.php?AJX_CMD=GL_ImageUpload" method="post" enctype="multipart/form-data" style="visibility:hidden;">
