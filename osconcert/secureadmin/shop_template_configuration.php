...
*/
	...
	frequire($FSESSION->language.'/shop_template_configuration.php',RLANG);
	
	$SHOPCONFIG=(new instance)->getTweakObject('display.shopTemplateConfiguration');
	checkAJAX('SHOPCONFIG');	 
	
	$FSESSION->set("AJX_ENCRYPT_KEY",rand(1,10));
	 
	$jsData->VARS["page"]=array('lastAction'=>false,'opened'=>array(),'locked'=>false,'NUlanguages'=>tep_get_languages(),'imgPath'=>DIR_WS_IMAGES,"menu"=>array(),'editorLoaded'=>false,'link'=>tep_href_link(FILENAME_TEMPLATE_CONFIGURATION),'NUeditorControls'=>array(),'searchMode'=>false,'AJX_KEY'=>$FSESSION->AJX_ENCRYPT_KEY,'crypted'=>$ENCRYPTED,'alterRows'=>true);
	...
	$jsData->VARS["page"]["NUmenuGroups"]=array("normal","update","new_update");
...
<script type="text/javascript" src="includes/tweak/js/shop_template_configuration.js"></script>
<?php
	require(DIR_WS_INCLUDES . 'tweak/tinyMce.php');
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
	...
	<tr>
		<td class="main" id="shopConfig-1message">
		</td>
	</tr>
	<tr>
		<td>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td id="shopConfigtotalContentResult">
					<?php $SHOPCONFIG->doItems();?>
				</td>
			</tr>
		</table>
		</td>
