		...
		for ($icnt=0;$icnt<sizeof($output_array);$icnt++) {
			...
			if ($type=='head')
			{
				if($report_display_header==strtolower($element['content'])){
					...
					$result.="" . TEXT_SEATS . "\n";
					$result.=TEXT_ID . ''.SEP.'' . SEAT_NAME . ''.SEP.'' . ORDER_ID . ''.SEP.'' . TICKET_ID . ''.SEP.'' . TICKET_PRINTED . ''.SEP.'' . DATE_ID . ''.SEP.'' . SHOW . ''.SEP.'' . TEXT_CLIENT . ''.SEP.'' . TEXT_BILLING_NAME . ''.SEP.'' . QTY . ''.SEP.'' . TEXT_STATUS . ''.SEP.'' . TEXT_PAYMENT . ''.SEP.'' . TEXT_PURCHASED . ''.SEP.'' . TEXT_AMOUNT . ''.SEP.'' . TEXT_TAX . "\n";
				} else{
					$report_display='reject';
				}
			} else if (($type==$sub) && ($report_display=='accept')){//
...
########################################################################################################				
			...
			foreach($list_tickets as $key=> $value)
			{
			$result.=$element["col2"] . ''.SEP.'' . utf8_decode($element["col"]) . ''.SEP.'' . utf8_decode($element["col1"]) . ''.SEP.'' . $value . ''.SEP.'' . $element["col10"] . ''.SEP.'' . $element["col4"] . ''.SEP.'' . $element["col11"] . ''.SEP.'' . utf8_decode($element["col3"]) . ''.SEP.'' . utf8_decode($element["col8"]) . ''.SEP.'' .  "1," . utf8_decode($element["col5"]) . ''.SEP.'' . utf8_decode($element["col12"]) . ''.SEP.'' . $element["col13"] . ''.SEP.'' .  $currencies->format($element["col100"]/ sizeof($list_tickets)) . ''.SEP.'' . $element["col98"] . "\n";
			}
			...
			// and process as normal
			$result.=
			$element["col2"] . ''.SEP.'' . utf8_decode($element["col"]) . ''.SEP.'' . utf8_decode($element["col1"]) . ''.SEP.'' . $element["col9"] . ''.SEP.'' . $element["col10"] . ''.SEP.'' . $element["col4"] . ''.SEP.'' . $element["col11"] . ''.SEP.'' . utf8_decode($element["col3"]) . ''.SEP.'' . utf8_decode($element["col8"]) . ''.SEP.'' . $element["col7"] . ''.SEP.'' . utf8_decode($element["col5"]) . ''.SEP.'' . utf8_decode($element["col12"]) . ''.SEP.'' . $element["col13"] . ''.SEP.'' . $element["col6"] . ''.SEP.'' . $element["col98"] . "\n";
			}
			}else
			{			

			$result.=$element["col2"] . ''.SEP.'' . utf8_decode($element["col"]) . ''.SEP.'' . utf8_decode($element["col1"]) . ''.SEP.'' . $element["col9"] . ''.SEP.'' . $element["col10"] . ''.SEP.'' . $element["col4"] . ''.SEP.'' . $element["col11"] . ''.SEP.'' . utf8_decode($element["col3"]) . ''.SEP.'' . utf8_decode($element["col8"]) . ''.SEP.'' . $element["col7"] . ''.SEP.'' . utf8_decode($element["col5"]) . ''.SEP.'' . utf8_decode($element["col12"]) . ''.SEP.'' . $element["col13"] . ''.SEP.'' . $element["col6"] . ''.SEP.'' . $element["col98"] . "\n";
			}
		...
		for ($icnt=0;$icnt<sizeof($output_array);$icnt++) 
		{
			...
			if ($type=='head')
			{
				if($report_display_header==strtolower($element['content']))
				{
					...
					//$result.=$element['content'] . "\n";
					$result.="" . TEXT_SEATS . "\n";
					$result.=TEXT_ID . ''.SEP.'' . SEAT_NAME . ''.SEP.'' . ORDER_ID . ''.SEP.'' . TICKET_ID . ''.SEP.'' . DATE_ID . ''.SEP.'' . SHOW . ''.SEP.'' . TEXT_CLIENT . ''.SEP.'' . TEXT_BILLING_NAME . ''.SEP.'' . TEXT_COMPANY . ''.SEP.'' . TEXT_STREET_ADDRESS . ''.SEP.'' . TEXT_SUBURB . ''.SEP.'' . TEXT_POSTCODE . ''.SEP.'' . TEXT_STATE . ''.SEP.'' . TEXT_TELEPHONE . "\n";
				} else
				{
					$report_display='reject';
				}
			...
			$list_tickets=explode("<br/>", rtrim($element["col9"],'<br/>'));
				if(sizeof($list_tickets)>1)
				{
					...
					$result.=
					// $element["col2"] . ''.SEP.'' . utf8_decode($element["col"]) . ''.SEP.'' . utf8_decode($element["col1"]) . ''.SEP.'' . $value . ''.SEP.'' . $element["col10"] . ''.SEP.'' . $element["col4"] . ''.SEP.'' . $element["col11"] . ''.SEP.'' . utf8_decode($element["col3"]) . ''.SEP.'' . utf8_decode($element["col8"]) . ''.SEP.'' .  "1," . utf8_decode($element["col5"]) . ''.SEP.'' . utf8_decode($element["col12"]) . ''.SEP.'' . $element["col13"] . ''.SEP.'' .  $currencies->format($element["col100"]/ sizeof($list_tickets)) . ''.SEP.'' . $element["col98"] . "\n";
					$element["col2"] . ''.SEP.'' . utf8_decode($element["col"]) . ''.SEP.'' . $element["col1"] . ''.SEP.'' . $element["col9"] . ''.SEP.'' . $element["col4"] . ''.SEP.'' . utf8_decode($element["col11"]) . ''.SEP.'' . utf8_decode($element["col3"]) . ''.SEP.'' . utf8_decode($element["col8"]) . ''.SEP.'' . utf8_decode($element["col15"]) . ''.SEP.'' . utf8_decode($element["col16"]) . ''.SEP.'' . utf8_decode($element["col17"]) . ''.SEP.'' . utf8_decode($element["col18"]) . ''.SEP.'' . utf8_decode($element["col19"]) . ''.SEP.'' . $element["col22"] . "\n";
					}
