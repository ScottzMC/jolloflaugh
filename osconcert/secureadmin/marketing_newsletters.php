...
*/
	...
	frequire($FSESSION->language.'/marketing_newsletters.php',RLANG);
	 
	$MARKETINGNEWSLETTERS=(new instance)->getTweakObject('display.marketingNewsletters');
	$MARKETINGNEWSLETTERS->pagination=true;
	checkAJAX('MARKETINGNEWSLETTERS');	 
	
	$FSESSION->set("AJX_ENCRYPT_KEY",rand(1,10));
	 
	$jsData->VARS["page"]=array('NUeditorControls'=>array(),'editorLoaded'=>false,'lastAction'=>false,'opened'=>array(),'locked'=>false,'NUlanguages'=>$LANGUAGES,'imgPath'=>DIR_WS_IMAGES,"menu"=>array(),'link'=>tep_href_link('marketing_newsletters.php'),'searchMode'=>false,'AJX_KEY'=>$FSESSION->AJX_ENCRYPT_KEY,'crypted'=>$ENCRYPTED,'alterRows'=>true);
	$jsData->VARS["page"]["template"]=array("ERROR_NEWSLETTER_TITLE"=>ERROR_NEWSLETTER_TITLE,
	...
	$jsData->VARS["page"]["NUmenuGroups"]=array("normal","update","display","unlock");
...
<script type="text/javascript" src="includes/tweak/js/marketing_newsletters.js"></script>
</head>
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td id="mnltotalContentResult">
					<?php $MARKETINGNEWSLETTERS->doNewsletters();?>
				</td>
			</tr>
		</table>
		</td>
	...
	<form name="fileUpload" id="fileUpload" action="marketing_newsletters.php?AJX_CMD=GL_ImageUpload" method="post" enctype="multipart/form-data" style="visibility:hidden;">
