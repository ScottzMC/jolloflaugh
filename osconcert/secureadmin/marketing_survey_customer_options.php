...
*/
	...
	frequire($FSESSION->language.'/marketing_survey_customer_options.php',RLANG);
	 
	$CUSTOMEROPTIONS=(new instance)->getTweakObject('display.marketingSurveyCustomerOptions');
	$CUSTOMEROPTIONS->pagination=true;
	checkAJAX('CUSTOMEROPTIONS');	 
	
	$FSESSION->set("AJX_ENCRYPT_KEY",rand(1,10));
	$type=$FREQUEST->getvalue('type');
	 
	$jsData->VARS["page"]=array('lastAction'=>false,'opened'=>array(),'locked'=>false,'NUlanguages'=>$LANGUAGES,'imgPath'=>DIR_WS_IMAGES,"menu"=>array(),'link'=>tep_href_link('marketing_survey_customer_options.php'),'searchMode'=>false,'AJX_KEY'=>$FSESSION->AJX_ENCRYPT_KEY,'crypted'=>$ENCRYPTED,'alterRows'=>true);
	$jsData->VARS["page"]["template"]=array("ERR_OPTIONS_NAME"=>(($type=='I')?ERR_OPTIONS_NAME_INTEREST:ERR_OPTIONS_NAME_OCCUPATION),
...
<script type="text/javascript" src="includes/tweak/js/marketing_survey_customer_options.js"></script>
</head>
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
	...
	<tr class="dataTableHeadingRow">
		...
		<tr>
				<td class="main">
					<b><?php echo (($type=='I')?HEADING_TITLE_INTERESTS:HEADING_TITLE_OCCUPATIONS);?></b>
				</td>
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td id="msctotalContentResult">
					<?php $CUSTOMEROPTIONS->doCustomerOptions();?>
				</td>
			</tr>
		</table>
		</td>
	...
	<form name="fileUpload" id="fileUpload" action="marketing_survey_customer_options.php?AJX_CMD=GL_ImageUpload" method="post" enctype="multipart/form-data" style="visibility:hidden;">
