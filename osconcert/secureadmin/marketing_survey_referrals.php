...
*/
	...
	frequire($FSESSION->language.'/marketing_survey_referrals.php',RLANG);
	 
	$SURVEYREFERRALS=(new instance)->getTweakObject('display.marketingSurveyReferrals');
	$SURVEYREFERRALS->pagination=true;
	checkAJAX('SURVEYREFERRALS');	 
	
	$FSESSION->set("AJX_ENCRYPT_KEY",rand(1,10));
	 
	$jsData->VARS["page"]=array('lastAction'=>false,'opened'=>array(),'locked'=>false,'NUlanguages'=>$LANGUAGES,'imgPath'=>DIR_WS_IMAGES,"menu"=>array(),'link'=>tep_href_link('marketing_survey_referrals.php'),'searchMode'=>false,'AJX_KEY'=>$FSESSION->AJX_ENCRYPT_KEY,'crypted'=>$ENCRYPTED,'alterRows'=>true);
	$jsData->VARS["page"]["template"]=array("ERR_SOURCES_NAME"=>ERR_SOURCES_NAME,
...
<script type="text/javascript" src="includes/tweak/js/marketing_survey_referrals.js"></script>
</head>
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td id="msrtotalContentResult">
					<?php $SURVEYREFERRALS->doReferrals();?>
				</td>
			</tr>
		</table>
		</td>
	...
	<form name="fileUpload" id="fileUpload" action="marketing_survey_referrals.php?AJX_CMD=GL_ImageUpload" method="post" enctype="multipart/form-data" style="visibility:hidden;">
