...
// class methods
    function quote($method = '') {
      ...
      if (tep_not_null($this->icon)) $this->quotes['icon'] = $this->title;//tep_image($this->icon, $this->title);
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, set_function) values ('Enable Free Shipping', 'MODULE_SHIPPING_FREESHIPPER_STATUS', 'True', 'Do you want to offer Free shipping?', '6', '5', now(),'tep_cfg_select_option(array(\'True\', \'False\'),')");
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('FREESHIPPER Sort Order', 'MODULE_SHIPPING_FREESHIPPER_SORT_ORDER', '8', 'Sort order of display.', '6', '0', now())");
    }
