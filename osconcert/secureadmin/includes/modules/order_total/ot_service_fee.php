...
defined('_FEXEC') or die();
  ...
  class ot_service_fee {
    ...
    function process() {
      ...
      if ($od_amount > 0) {
        if (MODULE_ORDER_TOTAL_SERVICE_FEE_RATE_TYPE == 'percentage') $title_ext = sprintf(MODULE_ORDER_TOTAL_SERVICE_FEE_PERCENTAGE_TEXT_EXTENSION ,$this->calculate_rate($this->count_cart_contents_with_fee()));
		if (MODULE_ORDER_TOTAL_SERVICE_FEE_RATE_TYPE == 'flat rate') $title_ext = sprintf(MODULE_ORDER_TOTAL_SERVICE_FEE_FLAT_RATE_TEXT_EXTENSION ,($this->count_cart_contents_with_fee() .' x '.$currencies->format(MODULE_ORDER_TOTAL_SERVICE_FEE_RATES) ));
...
*/
    ...
    function keys() {
      return array('MODULE_ORDER_TOTAL_SERVICE_FEE_STATUS', 'MODULE_ORDER_TOTAL_SERVICE_FEE_SORT_ORDER', 'MODULE_ORDER_TOTAL_SERVICE_FEE_DISABLE_WITH_COUPON', 'MODULE_ORDER_TOTAL_SERVICE_FEE_RATE_TYPE', 'MODULE_ORDER_TOTAL_SERVICE_FEE_RATES', 'MODULE_ORDER_TOTAL_SERVICE_FEE_INC_SHIPPING', 'MODULE_ORDER_TOTAL_SERVICE_FEE_INC_TAX', 'MODULE_ORDER_TOTAL_SERVICE_FEE_CALC_TAX','MODULE_ORDER_TOTAL_SERVICE_FEE_BOX_OFFICE','MODULE_ORDER_TOTAL_SERVICE_FEE_EXEMPT_CAT');
    }
