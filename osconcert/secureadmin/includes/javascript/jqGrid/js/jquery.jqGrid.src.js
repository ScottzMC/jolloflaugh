	...
	$.fn.fmatter.rowactions = function(rid,gid,act,pos) {
		...
		switch(act)
		{
			case 'edit':
				...
				/* fix: in order to have only 1 row in edit mode at a time */
				if(lastsel!=0){$.fn.fmatter.rowactions(lastsel,'concert_grid','cancel',11);}
				lastsel=rid;
			...
			case 'save':
				...
				/* fix: resetting the last selected id on cancel*/
				lastsel = 0;
	...
	sortableRows : function (opts) {
		...
		return this.each(function(){
			...
			if($.fn.sortable) {
				...
				/* the following line prevents in-line editing */
