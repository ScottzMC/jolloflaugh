...
if($chk_advise=='Y')
{
	...
	// $customers_language_directory=$check_language['directory'];
			...
			$order_result=tep_db_fetch_array($orders_query_raw);	
				...
				if($chk_type=='F')//full refunds restock
				{
				...
				tep_db_query("update " . TABLE_ORDERS_PRODUCTS . " set events_type='R' where orders_id='" . (int)$oID ."'");
			...
			{
				echo '<table cellpadding="3" cellspacing="5" border="0" width="80%" align="center"><tr><td class="main">' . TEXT_CANNOT_REFUND . $order_amount . '<td><tr><tr><td>' . tep_draw_separator('pixel_trans.gif','10','10'). '</td></tr></table>';
			}
			break;
		}
                                            ...
                                            <td colspan="2">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
														...
														<textarea class="inputNormal" name="refund_comments" id="refund_comments" rows="5" cols="40"></textarea></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>-->
