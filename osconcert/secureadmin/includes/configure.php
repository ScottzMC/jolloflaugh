...
// * DIR_WS_* = Webserver directories (virtual/URL)
  ...
  define('HTTP_CATALOG_SERVER', 'https://jollofnlaugh.com');
  define('HTTPS_CATALOG_SERVER', 'https://jollofnlaugh.com');
  define('ENABLE_SSL_CATALOG', 'true'); // secure webserver for catalog module
  define('DIR_FS_DOCUMENT_ROOT', '/home/storm/sites/jollofnlaugh-com/public/osconcert/'); // where the pages are located on the server
  define('DIR_WS_ADMIN', '/osconcert/secureadmin/'); // absolute path required
  define('DIR_FS_ADMIN', '/home/storm/sites/jollofnlaugh-com/public/osconcert/secureadmin/'); // absolute pate required
  define('DIR_WS_CATALOG', '/osconcert/'); // absolute path required
  define('DIR_FS_CATALOG', '/home/storm/sites/jollofnlaugh-com/public/osconcert/'); // absolute path required
