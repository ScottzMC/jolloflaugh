...
###############################################################
//for extra fields
define("TEXT_XF","Extra_Fields");
define("NOTE"," (Agents Note) ");
//invoice
...
// define("TEST_MAIL_SE","STORE_OWNER_EMAIL_ADDRESS");
...
define("TEST_STORE_AD","STORE_NAME_ADDRESS");
...
//test email
define("TEST_MAIL_FN","First_Name");
define("TEST_MAIL_LN","Last_Name");
define("TEST_ORDR_NO","87654321");
define("TEST_ORDR_OP",strftime(DATE_FORMAT_LONG));
define("TEST_ORDR_OL",tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO ,'order_id=87654321'));
...
define("TEST_ORDR_CF",STORE_OWNER);
define("TEST_ORDR_CL","");
define("TEST_ORDR_CM",STORE_NAME);
...
define("TEST_ORDR_CA",STORE_OWNER_EMAIL_ADDRESS);
define('TEST_ORDR_BDM','Bank_Deposit_Message');
...
//Refund
define("REFUND_TEXT_1","Refund_Message_1");
//OSU 
...
//wallet
define("TEXT_TYPE_WALLET_FUC","Wallet Funds Upload Confirmation");
define("TEXT_TYPE_WALLET_BW","Wallet Balance Warning");
