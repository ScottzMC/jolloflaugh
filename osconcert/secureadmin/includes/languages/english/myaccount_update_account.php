...
define('TEXT_IMPORTANT','<span class="red">IMPORTANT:</span> Please create a very strong password using symbols numbers and letters. Remember to record your changes securely. After this change, the only way to reset the Admin user details will be by a direct change to the database. For security reasons email password recovery has been removed.');
...
define('TEXT_INFO_NEW_PASSWORD','<b>Password/<br>New Password: </b>');
define('TEXT_INFO_PASSWORD_HIDDEN', '-Hidden-');
define('TEXT_INFO_PASSWORD_CONFIRM', '<b>Confirm Password: </b>');
define('TEXT_INFO_PASSWORD_CURRENT', '<b>Current Password: </b>');
...
define('TEXT_PASSWORD_ERROR', 'Wrong Password.');
...
define('JS_ALERT_CURRENT_PASSWORD',  '- Required  Current Password \n');
define('JS_ALERT_CURRENT_PASSWORD_ERROR',  '- The Current Password should have 5 characters \n');
define('JS_ALERT_NEW_PASSWORD',  '- Required Password \n');
define('JS_ALERT_NEW_PASSWORD_ERROR',  '- The New Password should have 5 characters \n');
define('JS_ALERT_CONFIRM_PASSWORD',  '- Required  Confirm Password \n');
define('JS_ALERT_CONFIRM_PASSWORD_ERROR',  '- The Confirm Password should have 5 characters \n');
define('JS_ALERT_FIRSTNAME_ERROR',  '- The Firstname should have 5 characters \n');
define('JS_ALERT_LASTNAME_ERROR',  '- The Lastname should have 5 characters \n');
define('JS_ALERT_NEW_CONFIRM_ERROR',  '- The Password and Confirm Password should be same \n');
...
define('ERRORS',                '-The Following Error(s) Occured \n\n');

define("PASSWORD_CHANGED_SUCCESFULLY", "The Administration Tool user details has been changed successfully");
...
define('TEXT_INFO_INFO', '<br>Please change your personal details above and then enter and confirm your password to save the changes.<br><br>You may also change your password by just entering the new password and then confirming the new one.');
?>
