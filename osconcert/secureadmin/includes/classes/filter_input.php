...
class filter_input
{
	...
	var $tagScriptlist = array ('script','applet','frameset');
	...
	function _cleanScriptTags($source){
		...
		while ($tagOpen_start !== false)
		{
			 ...
			 */
			if ((!preg_match("/^[a-z][a-z0-9]*$/i", $tagName)) || (!$tagName) || ((in_array(strtolower($tagName), $this->tagScriptlist)) && ($this->xssAuto))) {
