...
*/
	...
	frequire($FSESSION->language.'/shop_orders_status.php',RLANG);
	
	 $languages = tep_get_languages();
	 
	$SHOPORDERSTATUS=(new instance)->getTweakObject('display.shopOrdersStatus');
	$SHOPORDERSTATUS->pagination=true;
	checkAJAX('SHOPORDERSTATUS');	 
	
	$FSESSION->set("AJX_ENCRYPT_KEY",rand(1,10));
	 
	$jsData->VARS["page"]=array('lastAction'=>false,'opened'=>array(),'locked'=>false,'NUlanguages'=>$LANGUAGES,'imgPath'=>DIR_WS_IMAGES,"menu"=>array(),'link'=>tep_href_link('shop_orders_status.php'),'searchMode'=>false,'AJX_KEY'=>$FSESSION->AJX_ENCRYPT_KEY,'crypted'=>$ENCRYPTED,'alterRows'=>true);
	$jsData->VARS["page"]["template"]=array("ERR_STATUS_NAME"=>ERR_STATUS_NAME,
...
<script type="text/javascript" src="includes/tweak/js/shop_orders_status.js"></script>
</head>
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td id="sostotalContentResult">
					<?php $SHOPORDERSTATUS->doshopOrdersStatus();?>
				</td>
			</tr>
		</table>
		</td>
	...
	<form name="fileUpload" id="fileUpload" action="shop_orders_status.php?AJX_CMD=GL_ImageUpload" method="post" enctype="multipart/form-data" style="visibility:hidden;">
