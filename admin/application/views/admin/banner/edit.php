...
<head>
    ...
    <title>Edit <?php echo $ban->title; ?> Banner || Ticket Event</title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?php echo site_url('banner/view'); ?>">Banner</a></li>
						<li class="breadcrumb-item active"><a href="javascript:void(0)"><?php echo $ban->title; ?></a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('banner/edit/'.$ban->id); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-title">Title</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="title" placeholder="Enter a Title" value="<?php echo $ban->title; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="video" placeholder="Video URL" value="<?php echo $ban->video; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('banner/edit_image/'.$ban->id); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group row">
