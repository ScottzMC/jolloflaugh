...
<head>
    ...
    <title>Edit <?php echo $vd->title; ?> Videos || Ticket Event</title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?php echo site_url('videos/view'); ?>">Videos</a></li>
						<li class="breadcrumb-item active"><a href="javascript:void(0)"><?php echo $vd->title; ?></a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('videos/edit/'.$vd->id); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-title">Title</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="title" placeholder="Enter a Title" value="<?php echo $vd->title; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-video">URL</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="url" placeholder="URL" value="<?php echo $vd->url; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-video">Playlist</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="playlist" placeholder="Playlist" value="<?php echo $vd->playlist; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
