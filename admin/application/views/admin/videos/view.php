...
<head>
    ...
    <title>View Videos || Ticket Event</title>
    <!-- Favicon icon -->
			...
			<div class="container-fluid">
				...
				<script>
                  function deleteVideos(id){
                    ...
                    $.post('<?php echo base_url('videos/delete'); ?>', {"del_id": del_id}, function(data){
                      location.reload();
                      $('#cte').html(data)
                      });
                    }
								...
								<div class="table-responsive fs-14">
									<table class="table mb-4 dataTablesCard no-hover card-table fs-14" id="example5">
										...
										<tbody>
											...
											<tr>
												<td class="d-none d-lg-table-cell"><?php echo $vd->id; ?></td>
												<td class="d-none d-lg-table-cell"><h4 class="font-w600 mb-1 wspace-no"><a href="javascript:void(0)" class="text-black"><?php echo $vd->title; ?></a></h4></td>
												<td class="d-none d-lg-table-cell"><h4 class="font-w600 mb-1 wspace-no"><a href="javascript:void(0)" class="text-black"><?php echo $vd->type; ?></a></h4></td>
												<td class="d-none d-lg-table-cell"><h4 class="font-w600 mb-1 wspace-no"><a href="javascript:void(0)" class="text-black"><?php echo $vd->url; ?></a></h4></td>
												<td class="d-none d-lg-table-cell"><h4 class="font-w600 mb-1 wspace-no"><a href="javascript:void(0)" class="text-black"><?php echo $vd->playlist; ?></a></h4></td>
												<td>
													<div class="d-flex">
														<a href="<?php echo site_url('videos/edit/'.$vd->id); ?>" class="btn btn-info btn-sm light px-4">Edit</a>
													</div>
												</td>
												<td>
													<div class="d-flex">
														<button type="button" onclick="deleteVideos(<?php echo $vd->id; ?>)" class="btn btn-danger btn-sm light ml-2 px-4">Delete</button>
													</div>
												</td>
											</tr>
											<?php } } ?>
