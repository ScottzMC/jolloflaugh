...
<head>
    ...
    <title>Add Videos || Ticket Event</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('videos/add'); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-video">YouTube URL</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="url" placeholder="YouTube URL">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-video">YouTube Playlist</label>
                                                    <div class="col-lg-6">
