...
<head>
    ...
    <title>Add Venue || Admin Dashboard</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                ...
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Add Venue</a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('venue/add'); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <textarea id="summernote" class="form-control" name="body" placeholder=""></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-lg-4 col-form-label" for="val-confirm-password">Upload First Image 
                                                ...
                                                <div class="form-group row">
                                                   <label class="col-lg-4 col-form-label" for="val-confirm-password">Upload Second Image 
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <div class="custom-file">
