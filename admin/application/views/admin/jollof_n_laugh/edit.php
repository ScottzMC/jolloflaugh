...
<head>
    ...
    <title>Edit <?php echo $eve->title; ?> || Admin Dashboard</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                ...
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Edit <?php echo $eve->title; ?></a></li>
					</ol>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Jollof N Laugh</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('jollof_n_laugh/edit/'.$eve->id); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-title">Title</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="title" placeholder="Enter a Title" value="<?php echo str_replace('-', ' ', $eve->title); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-video">Description</label>
                                                    <div class="col-lg-6">
                                                        <textarea id="summernote" class="form-control" name="description"><?php echo $eve->description; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-title">Video URL</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="video" placeholder="Enter a Video URL" value="<?php echo $eve->video; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-video">Maps</label>
                                                    <div class="col-lg-6">
                                                        <textarea col="7" rows="7" class="form-control" name="maps"><?php echo $eve->maps; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-title">Age Requirements</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="req_age" value="<?php echo $eve->req_age; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-title">Dress code Requirements</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="req_dress_code" value="<?php echo $eve->req_dress_code; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-title">Last Entry Requirements</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="req_last_entry" value="<?php echo $eve->req_last_entry; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-title">ID Requirements</label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="req_id_verified" value="<?php echo $eve->req_id_verified; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Events Image</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url('jollof_n_laugh/edit_image/'.$eve->id); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group row">
