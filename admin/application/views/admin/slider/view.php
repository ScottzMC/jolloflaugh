...
<head>
    ...
    <title>View Slider || Ticket Event</title>
    <!-- Favicon icon -->
			...
			<div class="container-fluid">
				...
				<script>
                  function deleteSlider(id){
                    ...
                    $.post('<?php echo base_url('slider/delete'); ?>', {"del_id": del_id}, function(data){
                      location.reload();
                      $('#cte').html(data)
                      });
                    }
								...
								<div class="table-responsive fs-14">
									<table class="table mb-4 dataTablesCard no-hover card-table fs-14" id="example5">
										...
										<tbody>
											...
											<tr>
												<td class="d-none d-lg-table-cell"><?php echo $slid->id; ?></td>
												<td class="d-none d-lg-table-cell"><h4 class="font-w600 mb-1 wspace-no"><a href="javascript:void(0)" class="text-black"><?php echo $slid->title; ?></a></h4></td>
												<td>
													<div class="media align-items-center">
														<img class="img-fluid rounded mr-3 d-none d-xl-inline-block" width="120" src="https://scottnnaghor.com/jollof_n_laugh/uploads/slider/<?php echo $slid->image; ?>" alt="<?php echo $slid->title; ?>">
													</div>
												</td>
												<td class="d-none d-lg-table-cell"><h4 class="font-w600 mb-1 wspace-no"><a href="javascript:void(0)" class="text-black"><?php echo $slid->type; ?></a></h4></td>
												<td>
													<div class="d-flex">
														<a href="<?php echo site_url('slider/edit/'.$slid->id); ?>" class="btn btn-info btn-sm light px-4">Edit</a>
													</div>
												</td>
												<td>
													<div class="d-flex">
														<button type="button" onclick="deleteSlider(<?php echo $slid->id; ?>)" class="btn btn-danger btn-sm light ml-2 px-4">Delete</button>
													</div>
												</td>
											</tr>
											<?php } } ?>
