<?php 
    ...
    class Slider extends CI_Controller{
        ...
        public function view(){
            $data['slider'] = $this->Data_model->display_all_slider();
        ...
        public function add(){
            ...
            if(isset($submit_btn)){
               ...
               $config = array(
                ...
                $insert_slider = $this->Data_model->insert_slider($add_array);

                if($insert_slider){ ?>
                <script>
                    alert('Added Successfully');
                    window.location.href="<?php echo site_url('slider/view'); ?>";
                </script>
        <?php }else{ ?>
                <script>
                    alert('Upload Failed');
        ...
        public function edit($id){
            $data['slider'] = $this->Data_model->display_slider_by_id($id);
            ...
            if(isset($submit_btn)){
                ...
                $update_data = $this->Data_model->update_slider($id, $update_array);
          ...
          <?php
                ...
                <script>
                    alert('Update Failed');
                    window.location.href="<?php echo site_url('slider/edit/'.$id); ?>";
                </script>
          <?php 
               }  
            }
        ...
        public function edit_image($id){
          ...
          if(isset($submit_btn)){
              ...
              $update_image = $this->Data_model->update_slider($id, $update_array);
        ...
        public function delete(){
           ...
           $this->Data_model->delete_slider($id); 
        }
    }
