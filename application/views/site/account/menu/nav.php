				...
				<div class="col-md-8 align-self-center">
					<div class="banner-img">
						<a href="<?php echo site_url('home'); ?>">
							<img class="img-fluid" src="<?php echo base_url('images/banner/banner4.jpg'); ?>" alt="Top Banner">
						</a>
					</div>
				</div>
				<!-- col end -->
			...
			<div class="row">
				<div class="col-md-4 align-self-center">
					<div class="header-logo">
						<a href="<?php echo site_url('home'); ?>">
							<img src="<?php echo base_url('images/logo/logo-v2.png'); ?>" alt="Logo">
						</a>
					</div>
				</div>
					...
					<nav class="navigation ts-main-menu navigation-landscape">
						...
						<div class="nav-menus-wrapper clearfix">
							...
							<ul class="nav-menu">
								...
								<li><a style="" href="https://jollof_n_laugh.com/fastfood/food_order" target="_blank">Book your meal</a></li>
