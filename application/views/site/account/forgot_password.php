...
<head>
	...
	<!-- Site Title- -->
	<title>Forgot Password || Jollof N Laugh</title>
				...
				<div class="col-lg-5 mx-auto">
					<div class="ts-grid-box">
						<div class="login-page">
							<h3 class="log-sign-title text-center mb-25">Please Log In, or <a href="<?php echo site_url('register'); ?>">Sign Up</a></h3>
							
							<form action="<?php echo base_url('forgot_password'); ?>" method="POST" role="form">
